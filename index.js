...
function discountPrice(customer) {
  ...
  return (burger.price) // if parameter is different than teacher, student, or public, it will display original price.
...
console.log(addRating(reviews, 'Mason', 1, 'It really sucked, I would not eat here again.'));
...
function getLastReview(reviews) {
  return `${reviews[8].name} gave the restaurant a ${reviews[8].rating} star review and their feedback was: ${reviews[8].feedback}`;
}
